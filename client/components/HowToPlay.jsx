    ...
    <div className='how-to-container'>
        ...
        <ul>
          ...
          <li>
            ...
            right will show how many letters of your guess are in the secret
            word and how many are in the right position.
          </li>
          <li>
          ...
          <li>
            Continue guessing until you correctly identify the secret word.
          </li>
        </ul>
        <p>
